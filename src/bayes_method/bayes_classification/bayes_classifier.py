...
class BayesClassifier:
    ...
    * Not working when one class contains much more samples.
    """
    @staticmethod
    def _add_labeled_skeleton(classes: dict, task_classes: list, categories: list, categorical_mask: list) -> dict:
    ...
    @staticmethod
    def _add_numerical_skeleton(classes: dict, task_classes: list, categories: list, categorical_mask: list) -> dict:
        for task_class in task_classes:
            if task_class not in classes:
                classes[task_class] = {}
            for category in categories:
    ...
    def _categorize_data(self, classes: dict, inputs: ndarray, target: ndarray, categories: list, categorical_mask: list, numerical_init: bool) -> dict:
        """
        :param classes:
        :param inputs:
        :param target:
    ...
    def init_classes(self, inputs: ndarray, target: ndarray, categories: list, categorical_mask: list, task_classes: list, numerical_init: bool) -> dict:
        """
